...
```python
from umwelt.kits.dream import run_dream_baseline
print(run_dream_baseline().summary())
```

**Not proven:** that dreaming improves play skill; live rest-gate wins; gradient fold-back.
